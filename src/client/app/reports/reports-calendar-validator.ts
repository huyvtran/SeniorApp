...
@Component({
  selector: 'reports-calendar-error-messages',
...
export class ReportsCalendarValidatorComponent {
    ...
    for (let propertyName in this.control.errors) {
      ...
      try {
        if (this.control.errors.hasOwnProperty(propertyName) && this.control.touched) {
          let errorMsg = ReportsValidationService.getValidatorErrorMessage(propertyName,this.control.errors[propertyName]);
