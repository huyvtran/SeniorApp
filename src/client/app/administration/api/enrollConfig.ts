...
export class EnrollConfig {
     ...
     * State List
     */
    public initStateList(adminOpt: string = 'adv') {
        if (adminOpt === 'adminAdv') {
            return [{ value: 'ALL', label: 'ALL' }, { value: 'CA', label: 'CA' },
            { value: 'CO', label: 'CO' }, { value: 'CT', label: 'CT' }, { value: 'GA', label: 'GA' },
            { value: 'IN', label: 'IN' }, { value: 'KS', label: 'KS' }, { value: 'KY', label: 'KY' },
            { value: 'ME', label: 'ME' }, { value: 'MO', label: 'MO' }, { value: 'NH', label: 'NH' },
            { value: 'NJ', label: 'NJ' }, { value: 'NM', label: 'NM' }, { value: 'NV', label: 'NV' },
            { value: 'NY', label: 'NY' }, { value: 'OH', label: 'OH' }, { value: 'TN', label: 'TN' },
     ...
     * App type List
     */
    public initApptypeList(adminOpt: string = 'adv') {
        if (adminOpt === 'adminAdv') {
     ...
     * BackEnd List
     */
    public initBackEndList(adminOpt: string = 'adv') {
        if (adminOpt === 'adminAdv') {
            return [{ value: 'ALL', label: 'ALL' }, { value: 'ACS', label: 'ACS' },
            { value: 'HOV', label: 'HOV' }, { value: 'MEDISYS', label: 'MEDISYS' },
